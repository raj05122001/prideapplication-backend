...
import requests
from mail_service.Otp_mail import Otp_mail
...
async def send_otp_msg_mail(phone_number: str,background_tasks: BackgroundTasks,db: Session = Depends(get_db), email: str = None):
